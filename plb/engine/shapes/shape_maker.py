...
class Shapes:
    ...
    def get_n_particles(self, volume):
        return max(int(volume / 0.2 ** 3) * 30000, 1)
    ...
    def add_box(self, init_pos, width, n_particles=30000, color=None, init_rot=None):
        # pass
    ...
    def add_sphere(self, init_pos, radius, n_particles=30000, color=None, init_rot=None):
        if n_particles is None:
            if self.dim == 3:
    ...
    def add_capsule(self, init_pos, radius, height, n_particles=30000, color=None, init_rot=None):
        if n_particles is None:
            if self.dim == 3:
                volume = (radius ** 3) * 4 * np.pi / 3
            else:
    ...
    def add_cylinder(self, init_pos, radius, height, n_particles=30000, color=None, init_rot=None):
        if n_particles is None:
            if self.dim == 3:
                volume = (radius ** 3) * 4 * np.pi / 3
            else:
